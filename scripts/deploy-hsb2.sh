...
scp "$REPO_ROOT/mappings.json" "$HSB2_HOST:$REMOTE_DIR/"
ssh "$HSB2_HOST" "mkdir -p $REMOTE_DIR/templates"
scp "$REPO_ROOT/templates/index.html" "$HSB2_HOST:$REMOTE_DIR/templates/"
